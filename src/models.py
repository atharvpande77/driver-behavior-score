...
class TelematicsEvent(Base):
    ...
    lac: Mapped[str | None] = mapped_column(String(16), nullable=True)
    cell_id: Mapped[str | None] = mapped_column(String(16), nullable=True)
    nmr1_lac: Mapped[str | None] = mapped_column(String(16), nullable=True)
    nmr1_cell_id: Mapped[str | None] = mapped_column(String(16), nullable=True)
    nmr1_signal_strength: Mapped[str | None] = mapped_column(String(16), nullable=True, comment="dBm")
    nmr2_lac: Mapped[str | None] = mapped_column(String(16), nullable=True)
    nmr2_cell_id: Mapped[str | None] = mapped_column(String(16), nullable=True)
    nmr2_signal_strength: Mapped[str | None] = mapped_column(String(16), nullable=True, comment="dBm")
    nmr3_lac: Mapped[str | None] = mapped_column(String(16), nullable=True)
    nmr3_cell_id: Mapped[str | None] = mapped_column(String(16), nullable=True)
    nmr3_signal_strength: Mapped[str | None] = mapped_column(String(16), nullable=True, comment="dBm")
    nmr4_lac: Mapped[str | None] = mapped_column(String(16), nullable=True)
    nmr4_cell_id: Mapped[str | None] = mapped_column(String(16), nullable=True)
    nmr4_signal_strength: Mapped[str | None] = mapped_column(String(16), nullable=True, comment="dBm")
